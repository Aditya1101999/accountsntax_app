...
class EditInvoiceItem extends StatefulWidget {
  const EditInvoiceItem({super.key});
...
class _EditInvoiceItemState extends State<EditInvoiceItem> {
  ...
  String? _selectedItemsOption = 'item1';
  String? _hsnError = '';
  ...
  void initState() {
    super.initState();
    _hsnController = TextEditingController(text: 'Britannia');
    _quantityController = TextEditingController(text: '3401');
    _rateController = TextEditingController(text: 'No.s');
    _taxController = TextEditingController(text: '100');
    _discountController = TextEditingController(text: '10');
    _openingRateController = TextEditingController(text: '40');
    _descriptionController = TextEditingController(text: 'Biscuits');
  }
