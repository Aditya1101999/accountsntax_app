...
class AddSupplierDetailsScreen extends StatefulWidget {
  const AddSupplierDetailsScreen({Key? key}) : super(key: key);

  @override
  _AddSupplierDetailsScreenState createState() =>
      _AddSupplierDetailsScreenState();
}

class _AddSupplierDetailsScreenState extends State<AddSupplierDetailsScreen> {
